...
if [[ $(command -v exa) ]] {
    ...
    alias lst='exa -lTabghs type -I .git --icons' # 输入lst,将展示类似于tree的树状列表。
} else {
...
########
zinit ice lucid wait=1 ascompletion && zinit snippet ~/.config/tmoe-zsh/git/share/completion/_zshtheme
